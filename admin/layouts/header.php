        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="user_list.php" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="brand_create.php">Create</a></li>
                            <li><a href="brand_list.php">List</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="method_create.php">Create</a></li>
                            <li><a href="method_list.php">List</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="product_detail_list.php">List</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="order_list.php" aria-expanded="false">
                            <i class="icon-notebook menu-icon"></i><span class="nav-text">Order Lists</span>
                        </a>
                    </li>
